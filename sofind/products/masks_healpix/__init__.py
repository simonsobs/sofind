...
class MasksHealpix(Product):
    ...
    def get_mask_healpix_fn(self, mask_fn=None, mask_type=None, subproduct='default',
    ...
    def read_mask_healpix(self, mask_fn=None, mask_type=None, subproduct='default',
        ...
        read_map_kwargs : dict, optional
            Any keyword arguments to pass to hp.read_map.
        kwargs : dict, optional
            Any additional keyword arguments used to format the mask filename.
        ...
        hp.ndmap
            The requested mask.
        """
        fn = self.get_mask_healpix_fn(mask_fn=mask_fn, mask_type=mask_type, 
